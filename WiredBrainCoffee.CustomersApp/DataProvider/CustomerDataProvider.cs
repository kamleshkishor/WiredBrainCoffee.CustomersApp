        ...
        public async Task<IEnumerable<Customer>> LoadCustomersAsync()
        {
            ...
            if (storageFile == null)
            {
                customerList = new List<Customer>
                {
                    ...
                    new Customer{FirstName="Kamlesh",LastName="Kishor",IsDeveloper=true},
                    new Customer{FirstName="Aarushi",LastName="Goyal",IsDeveloper=false},
                    new Customer{FirstName="Ankita",LastName="Gusain",IsDeveloper=false},
                };
            }
            else
            {
